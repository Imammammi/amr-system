        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs mt-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <div class="flex space-x-2">
                                ...
                                <div class="w-full">
                                    ...
                                    <form wire:submit.prevent="saveUser">
                                        <h3
                                            ...
                                            <span class="border-b-2 pb-1">Add User</span>
                                        </h3>
                                            ...
                                            <div class="mt-2">
                                                <label class="text-sm">
                                                    <textarea wire:model.defer="body"
                                                        ...
                                                        rows="7" placeholder="User content"></textarea>
                                        ...
                                        <footer
                                            ...
                                            <button wire:loading.remove wire:click="saveUser"
                                            ...
                                            <button wire:loading wire:target="saveUser"
                    ...
                    <a href="{{ url('admin/users-trashed') }}">
                        ...
                        @foreach ($users as $user)
                            <tr class="text-gray-700 dark:text-gray-400">
                                <td class="px-4 py-3 text-sm">
                                    <a href="{{ url('admin/user') }}/{{ $user->slug }}/{{ $user->id }}">
                                        {{ $user->name }}
                                    </a>
                                </td>
                                <td class="px-4 py-3 text-sm">
                                        ...
                                        <div x-cloak x-show="open"
                                            ...
                                            <div x-show="open" x-transition:enter="transition ease-out duration-150"
                                                ...
                                                <footer
                                                    ...
                                                    <button wire:loading wire:target="deleteUser({{ $user->id }})"
